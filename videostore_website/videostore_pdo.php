<?php
#@ _COMMENT_
# videostore_pdo.php - common functions for videostore PDO-based PHP scripts
#@ _COMMENT_

#@ _videostore_CONNECT_
# Function that uses our top-secret username and password to connect
# to the MySQL server to use the videostore database. It also enables
# exceptions for errors that occur for subsequent PDO calls.
# Return value is the database handle produced by new PDO().

function videostore_connect ()
{
  $dbh = new PDO("mysql:host=localhost;dbname=videostore",
